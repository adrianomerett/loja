...
--
-- Host: localhost
-- Tempo de geração: 12/10/2025 às 04:37
...
INSERT INTO `config` (`id`, `nameloja`, `slogan`, `fone`, `celular`, `email`, `bairro`, `rua`, `numero`, `instagran`, `facebook`, `x`, `version`) VALUES
(1, 'Tecno Mix', 'Onde a inovação nunca desliga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1.0.0');
...
(18, 'Notebbok Dell 14 Polegadas', '<p>DECRIÇÃO</p>', '<p>iNFO TEC</p>', 14, 2, 2, 1500.00, 1789.23, 1850.32, 'N', 'A'),
(19, 'TV 32 polegadas Samsung  Plasma', '<p>Tvs 32 polegadas com plasma</p>', '<p>TVs 32 poelgadas com plasma</p>', 15, 3, 0, 2154.61, 2300.00, 2500.00, 'S', 'A'),
(20, 'iPhone 16e Apple (128GB) Preto, Tela de 6,1', '<p>Descrição de iphne 16</p>', '<p>Informações de Iphone 16</p>', 15, 3, 16, 4500.00, 7812.45, 8901.24, 'S', 'A'),
...
--
ALTER TABLE `img`
  MODIFY `imgid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `subcategorias`
  MODIFY `subcategoriaid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
