...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo BASE_URL . "/public/assets/img/icon.ico"; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo URL_PAINEL . "/public/assets/fontawesome/css/all.min.css"; ?>">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL . "/public/assets/css/flex.css?version=" . VERSION; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL . "/public/assets/css/loja.css?version=" . VERSION; ?>">
<?php
